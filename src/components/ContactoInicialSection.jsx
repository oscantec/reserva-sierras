        ...
        <section className="px-4 py-6 md:py-10 bg-page-bg-inicio dark:bg-surface-card-dark">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="flex flex-col gap-2 mb-3 md:mb-4">
                    <div className="flex justify-between items-end">
                        ...
                        <div className="text-right hidden sm:block">
                            ...
                            <p className="text-xs text-text-muted dark:text-text-muted">A tu reserva</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="flex flex-col lg:flex-row gap-3 md:gap-4">
                    {/* Left - Info Card */}
                    <div className="flex-1 bg-surface-card dark:bg-surface-card-dark rounded-xl p-4 md:p-6 border border-border-card dark:border-border-card-dark hover:shadow-lg hover:scale-[1.01] transition-all duration-300">
                        <p className="text-sm md:text-base text-text-muted dark:text-text-muted mb-4 md:mb-6">
                            {config.welcomeText}
                        </p>

                        <div className="space-y-3 md:space-y-4">
                            {config.items.map((item, i) => (
                                <div key={i} className="flex items-start gap-3 p-3 bg-page-bg-inicio dark:bg-surface-card-dark rounded-lg border border-border-card dark:border-border-card-dark hover:shadow-md hover:scale-[1.02] transition-all duration-200">
                    ...
                    <div className="lg:w-[380px] shrink-0">
                        <div className="bg-surface-card dark:bg-surface-card-dark rounded-xl p-4 md:p-6 border border-border-card dark:border-border-card-dark hover:shadow-lg hover:scale-[1.01] transition-all duration-300">
                            <div className="flex justify-between items-center mb-4 md:mb-6">
                                <h3 className="text-lg font-bold">Contacta a {config.hostName}</h3>
                            </div>
                            ...
                            <a
                                ...
                                className="w-full h-12 rounded-lg bg-primary hover:bg-primary-hover text-white font-bold shadow-lg shadow-card transition-all flex items-center justify-center gap-2"
                            >
                            ...
                            <div className="flex items-center justify-center gap-2 mt-4 text-xs text-text-muted dark:text-text-muted">
                                <span className="material-symbols-outlined text-sm text-icon-color">verified</span>
